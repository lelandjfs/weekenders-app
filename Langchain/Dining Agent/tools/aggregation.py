"""
Aggregation Tool for Dining Agent
==================================

Uses Claude Haiku to parse web pages and combine with Google Places results.
Deduplicates and ranks restaurants.
"""
...
2. For each restaurant, extract:
   ...
   - rating: numeric rating (1-5) or null

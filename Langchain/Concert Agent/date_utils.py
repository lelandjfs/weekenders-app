...
if __name__ == "__main__":
    ...
    for agent_type in AgentType:
        start, end = get_weekend_dates(agent_type, "next")
        print(f"{agent_type.value.capitalize()} Agent (next weekend): {start} to {end}")

    print()
    print("Concert Agent convenience function:")
    start, end = get_concert_weekend_dates("next")
